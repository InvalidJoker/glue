package de.joker.glue.paper.items
 ...
 */
fun itemStack(material: Material, builder: (ItemStack.() -> Unit)? = null) =
    builder?.let { ItemStack(material).apply(it) } ?: ItemStack(material)
